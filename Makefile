...
ESP_HOSTNAME        ?= happy_bubbles_nfc
...
#MODULES ?= mqtt rest syslog serial
...
#CFLAGS	+= -Os -ggdb -std=c99 -Werror -Wpointer-arith -Wundef -Wl,-EL -fno-inline-functions \

CFLAGS	+= -Os -ggdb -std=c99 -Wpointer-arith -Wundef -Wl,-EL -fno-inline-functions \
...
$(BUILD_BASE)/espfs_img.o: html/ html/wifi/ espfs/mkespfsimage/mkespfsimage
	...
	$(Q) cp -r html/hippo.svg html_compressed/hippo.svg;
ifeq ("$(COMPRESS_W_HTMLCOMPRESSOR)","yes")
